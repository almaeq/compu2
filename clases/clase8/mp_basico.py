...
#    child1()
    ...
    print("========================================================")
    print("Parent ID",os.getpid())
    p1.start() # inicia el proceso hijo
    for i in range(10):
    ...
    p1.join()# espera a que el hijo termine
    print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    os.system("ps ft") #se usa para mostrar la lista de procesos y sus relaciones de jerarquía
