...
""" 
Este script demuestra cómo crear y gestionar un proceso en Python utilizando
multiprocessing, con interacciones claras entre el proceso padre e hijo y 
cómo gestionar correctamente la finalización de procesos para evitar zombies.
"""
def child1():
